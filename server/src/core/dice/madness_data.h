#pragma once
// ─── Dice!Next — COC7 madness symptom tables ────────────────
// Verbatim copy of the original Dice! RDConstant.h madness data
// (临时/总结疯狂 + 恐惧症/躁狂症). Chinese data; the reply wrapper
// is localized via i18n. Placeholders: {pc} {dur} {detail} {detail_roll} {nick}.
