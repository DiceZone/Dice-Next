...
static json makeDefaultConfig() {
    return json{
        ...
        {"backup", {
            ...
            {"auto_keep_days", 7},
            {"auto_selection", {{"config", true}, {"coreDatabase", true}, {"characterCards", true},
                                {"chatHistory", true}, {"gameLogs", true}, {"runtimeLogs", false},
                                {"auditLogs", false}, {"decks", true}, {"rules", true}, {"help", true},
                                {"cardTemplates", true}, {"jsPlugins", true}, {"luaMods", true},
                                {"uploadedAssets", false}, {"resourceImages", false},
